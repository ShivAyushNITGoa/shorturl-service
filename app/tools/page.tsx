...
import { LogOut, Zap, Code2, BookOpen, Palette } from 'lucide-react';
  ...
  const toolCategories = [
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'Online Extension (All Tools)', icon: '🧩', desc: 'Run all extension tools in the web app', link: '/extension' },
        { name: 'Image ↔ JSON Converters', icon: '🎨', desc: 'Image to JSON and JSON to Image with large-file support', link: '/tools/converters' },
      ]
    },
    {
